...
| **Style phrase** | the `style` preset's English phrase (realistic / ghibli / cel90, name-aligned with the character and art skills) must appear in every frame prompt — one drama, one look |
